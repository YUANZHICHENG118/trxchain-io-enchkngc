(function () {
    ...
    new Vue({
        ...
        data: {
            tab: 'main',
            contract_address: 'TAV9BbLqJhuux9rBjC73sFhrvuRbxMGo3w',
            upline: '',
            contract: {
                balance: 0,
                total_users: 0,
