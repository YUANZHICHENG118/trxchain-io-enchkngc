(function () {
    ...
    new Vue({
        ...
        data: {
            tab: 'main',
            contract_address: 'TD8Md8BAGD4Q3C9ozQ9dz3QEK9Juopvfrh',
            upline: '',
            contract: {
                balance: 0,
                total_users: 0,
